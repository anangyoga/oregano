...
<template>
  <div class="flex justify-between px-24 py-8 max-w-screen-xl mx-auto">
    <div class="max-w-md">
      ...
      <h1 class="pt-4 leading-tight text-6xl font-bold tracking-tighter">Healthy Lifestyle is your only <span class="text-green whitespace-nowrap">unfair advantage</span></h1>
      <p class="pt-8 text-lg font-normal text-gray-600 leading-relaxed">Choose healthy habits with Oregano daily meal prepared by our expert nutritionist and chef.</p>
